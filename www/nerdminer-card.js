...
window.customCards.push({ type: "nerdminer-card", name: "Nerdminer-HA", description: "Native per-miner telemetry and history" });
window.customCards.push({ type: "nerdminer-farm-card", name: "Nerdminer farm", description: "Native aggregate stats for all Nerdminers" });
